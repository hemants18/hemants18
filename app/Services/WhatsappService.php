...
class WhatsappService
{
     ...
     */
    public function sendMessage__old($contactUuId, $messageContent, $type="text", $buttons = [], $header = null, $footer = null)
    {
     ...
     public function sendMessage($contactUuId, $messageContent, $type="text", $buttons = [], $header = [], $footer = null, $buttonLabel = null, $userId = NULL)
    {
        $contact = Contact::where('uuid', $contactUuId)->first();
        $url = "https://graph.facebook.com/{$this->apiVersion}/{$this->phoneNumberId}/messages";
    ...
    public function getPhoneNumberVerify($data){
        $responseObject = new \stdClass();

        try {
            $response = Http::withHeaders([
                $this->setHeaders()
            ])->post("https://graph.facebook.com/{$this->apiVersion}/{$this->phoneNumberId}/messages", $data)->throw()->json();
