...
use Modules\IntelliReply\Models\AiKnowledgeBase;
use App\Models\Organization;
use App\Models\Setting;
use Modules\IntelliReply\Services\AIService;
...
class AiController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $data['rows'] = [];//$this->AIService->getRows($request);
    ...
    {
        $data['uuid'] = $uuid;
        $data['flow'] = AiKnowledgeBase::where('uuid', $uuid)->firstOrFail();
    ...
    public function store(Request $request)
    {
        ...
        $flow = $this->AIService->createFlow($data);
    ...
    {
        $flow = $this->AIService->toggle($request);

        return redirect('/automation/ai')->with(
            'status', [
                'type' => 'success', 
    ...
    public function update(Request $request, $uuid)
    {
        ...
        $flow = AiKnowledgeBase::where('uuid', $uuid)->firstOrFail();
        ...
        $flow = $this->AIService->updateFlow($uuid, $data, $request->publish);
    ...
    {
        $flow = $this->AIService->uploadMedia($request, $uuid, $stepId);
    ...
    {
        $this->AIService->deleteFlow($uuid);
