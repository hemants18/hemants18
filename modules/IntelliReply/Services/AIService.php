...
use Modules\IntelliReply\Resources\AiResource;
use Modules\IntelliReply\Validators\FlowValidator;
...
class AIService
{
    public function getRows(object $request)
    {
        ...
        $model = new AiKnowledgeBase;
        $searchTerm = $request->query('search');

        return AiResource::collection($model->listAll($organizationId, $searchTerm));
    }
     ...
     * @return Flow
     */
    public function createFlow(array $data): AiKnowledgeBase
    {
        $organizationId = session()->get('current_organization');
