...
Route::post('/team/update-status', [App\Http\Controllers\User\TeamController::class, 'onlineStatus']);
    ...
    Route::group(['middleware' => ['check.email.verification']], function () {
        ...
        Route::group(['middleware' => ['check.organization']], function () {
            ...
            Route::group(['middleware' => 'check.subscription'], function () {
                ...
                //for flow
                // Route::get('/automation/flows/contacts-lists', [App\Http\Controllers\User\ContactController::class, 'contactsLists']);
                ...
                Route::prefix('/automation/flows')->group(function () {
                    ...
                    Route::put('/{flow}/publish', [Modules\FlowBuilder\Controllers\FlowController::class, 'update']);    // Activate a flow
                    Route::put('/{flow}/unpublish', [Modules\FlowBuilder\Controllers\FlowController::class, 'update']);  // Deactivate a flow
                });
                
                //for flow builder
                // Route::get('/automation/flows',[App\Http\Controllers\User\FlowsBuilderController::class, 'index'])->name('flowsbuider');
                // Route::get('/automation/flows/{uuid}/builder',[App\Http\Controllers\User\FlowsBuilderController::class, 'builder'])->name('flowsbuider.builder');
                // Route::get('/automation/flows/create',[App\Http\Controllers\User\FlowsBuilderController::class, 'create'])->name('flowsbuider.create');
                // Route::post('/automation/flows/save',[App\Http\Controllers\User\FlowsBuilderController::class, 'save']);
                // Route::post('/automation/flows/upload-files',[App\Http\Controllers\User\FlowsBuilderController::class, 'uploadFile'])->name('flowsbuider.upload-files');
                // Route::post('/automation/flows/flow-builders',[App\Http\Controllers\User\FlowsBuilderController::class, 'store']);
...
Route::prefix('admin')->middleware(['auth:admin'])->group(function () {
    ...
    Route::post('/users/send-otp', [App\Http\Controllers\Admin\UserController::class, 'sendOtp']);
    Route::post('/users/verify-otp', [App\Http\Controllers\Admin\UserController::class, 'varifyOtp']);
    ...
    Route::post('/addons/setup/embedded-signup', [App\Http\Controllers\Admin\AddonController::class, 'store']);
