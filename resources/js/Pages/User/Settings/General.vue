                ...
                <form @submit.prevent="submitForm2()" class="md:w-[60em]">
                    ...
                    <!-- <div class="bg-white border border-slate-200 rounded-lg py-2 text-sm mb-4">
                        <div class="flex items-center px-4 pt-2 pb-4">
                            <div class="w-[60%]">
                                <h2 class="text-[17px]">
                                    {{ $t('Hide Mobile Number') }}
                                </h2>
                                <span class="flex items-center mt-1 text-slate-600">
                                    {{ $t('Show mobile number as 91********** on this devices') }}
                                </span>
                            </div>
                            <div class="w-[40%] ml-auto flex justify-end">
                                <div class="flex items-center gap-3">
                                    <FormToggleSwitch v-model="form2.hide_mobile" />
                                    <span class="text-sm font-medium">
                                        {{ form2.hide_mobile ? $t('Yes') : $t('No') }}
                                    </span>
                                </div>
                            </div>
                        </div>
...
<script setup>
    ...
    const props = defineProps({ contactGroups : Object, modules : Array, settings: Object, timezones: Array, organization: Array, countries: Array, sounds: Array });
    ...
    const form2 = useForm({
        ...
        hide_mobile: false,
        // hide_mobile: settings.value && settings.value.hide_mobile ? settings.value.hide_mobile : false,
    });
