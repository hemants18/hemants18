...
const format = (type = null) => {
    const emoji = typeof type != 'string' ? type.detail.unicode : '';
    ...
    if(type == 'bold'){
        ...
        newText = textInput.value.substring(0, start) + emoji + textInput.value.substring(end);
    }
            ...
            <div :class="'sm:col-span-6'">
                <div class="mt-2">
                    ...
                    <div v-if="showPicker" class="">
                      <emoji-picker @emoji-click="format"></emoji-picker>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-between mt-2 mb-2">
                ...
                <div class="flex items-center space-x-3">
                    <button
                      ...
                      class="text-xl p-2 hover:bg-gray-200 rounded-full"
                    >
                      😊
                    </button>
