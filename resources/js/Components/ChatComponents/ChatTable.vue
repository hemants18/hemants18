            ...
            <div class="flex space-x-2 hover:bg-gray-50 cursor-pointer py-3 px-4">
                ...
                <div class="w-[85%]">
                    <div class="flex justify-between">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                ...
                                class="bg-green-500 text-white text-xs px-2 py-[2px] rounded-full min-w-[20px] text-center"
                            >
                    ...
                    <div v-if="contact.last_chat.deleted_at === null" class="flex justify-between">
                        ...
                        <div v-if="contentType(contact.last_chat.metadata) ==='video'" class="text-slate-500 text-xs truncate self-end flex items-center" >
                        ...
                        <div v-if="contentType(contact.last_chat.metadata) ==='audio'" class="text-slate-500 text-xs truncate self-end flex items-center" >
                        ...
                        <div v-if="contentType(contact.last_chat.metadata) ==='sticker'" class="text-slate-500 text-xs truncate self-end flex items-center" >
                        ...
                        <div v-if="contentType(contact.last_chat.metadata) ==='location'" class="text-slate-500 text-xs truncate self-end flex items-center" >
