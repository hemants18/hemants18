        ...
        <div>
            ...
            <div class="flex items-center justify-between mt-2 space-x-4">
                ...
                <span>
                        ...
                        <svg v-if="content.status === 'accepted'" xmlns="http://www.w3.org/2000/svg" width="15" height="24" viewBox="0 0 24 24" role="img" aria-label="single tick">
                          <title>Single tick</title>
                          <path d="M4 12.5l4 4L20 5" fill="none" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
