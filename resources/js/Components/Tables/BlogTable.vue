<script setup>
    ...
    const deleteAction = (key) => {
        form.delete('/admin/blog/posts/' + key);
    }
    ...
    <Table :rows="rows">
        <TableHeader>
            <TableHeaderRow>
                ...
                <TableHeaderRowItem>{{ $t('Author') }}</TableHeaderRowItem>
                <TableHeaderRowItem>{{ $t('Featured') }}</TableHeaderRowItem>
                <TableHeaderRowItem>{{ $t('Published') }}</TableHeaderRowItem>
                <TableHeaderRowItem :position="'last'"></TableHeaderRowItem>
            </TableHeaderRow>
        </TableHeader>
        <TableBody>
            <TableBodyRow v-for="(item, index) in rows.data" :key="index">
                <TableBodyRowItem :position="'first'">{{ item.title }}</TableBodyRowItem>
                <TableBodyRowItem>{{ item?.category?.name }}</TableBodyRowItem>
                <TableBodyRowItem>{{ item?.author?.full_name }}</TableBodyRowItem>
                <TableBodyRowItem>{{ item.is_featured ? 'YES' : 'N/A' }}</TableBodyRowItem>
                <TableBodyRowItem>{{ $t(item.published ? 'YES' : 'N/A' ) }}</TableBodyRowItem>
